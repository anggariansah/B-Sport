...
/**
 * Created by anggariansah on 07/04/2018.
 */

public class AdapterKelolaLapangan extends ArrayAdapter<ItemKelolaLapangan> {
    private Activity activity;
    private List<ItemKelolaLapangan> itembaru;
    private ItemKelolaLapangan semuaobj;
    private int row;
    Context ctx;

    public AdapterKelolaLapangan(Activity act, int resource, List<ItemKelolaLapangan> arraylist) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.nomer.setText(semuaobj.getNomer().toString());
